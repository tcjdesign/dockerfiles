...
docker run --name [name of your data container] jonasbonno/ftb-skyblock:1.2.1 echo 'Data-only container'

Running ftb-infinity server:
docker run --tty=true --interactive=true --detach=true --name=[name of your container] --volumes-from [name of your data container] --publish=[port on your host]:25565 jonasbonno/ftb-skyblock:1.2.1
...
When upgrading:
To upgrade then delete the ftb-skyblock server and start new ftb-skyblock server with --volumes-from [name of your data container].
Settings will reset when upgrading.
Access the console to op and whitelist.
